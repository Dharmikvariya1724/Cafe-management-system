...
import { BUSINESS_NAME, BUSINESS_TAGLINE, CONTACT_INFO, BUSINESS_HOURS, OUTLETS } from '@/lib/constants'
    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-3 sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-heading font-extrabold text-xl leading-tight">{settings.siteName || BUSINESS_NAME}</h3>
                <p className="text-[10px] uppercase font-bold tracking-widest text-accent">{settings.siteTagline || BUSINESS_TAGLINE}</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/about" className="hover:underline">About {settings.siteName || BUSINESS_NAME}</Link>
              </li>
              <li>
        ...
        <div className="border-t border-primary-foreground/20 mt-8 pt-8 text-center text-xs text-primary-foreground/70 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p>&copy; {new Date().getFullYear()} Mahi Enterprise — {settings.siteName || BUSINESS_NAME} | Super Sandwich Co. All rights reserved.</p>
